...
class CameraXPreview : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding = ActivityCameraXpreviewBinding.inflate(layoutInflater)
...
//        }
    ...
    private fun captureVideo() {
        ...
        recording = videoCapture.output
            ...
            .apply {
                if (PermissionChecker.checkSelfPermission(this@CameraXPreview,
